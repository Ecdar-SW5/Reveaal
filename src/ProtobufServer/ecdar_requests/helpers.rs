use crate::{DataReader::component_loader::ComponentContainer, TransitionSystems::{CompiledComponent, TransitionSystem}, ProtobufServer::services::SimulationInfo};

pub fn simulation_info_to_transition_system(simulation_info : SimulationInfo) -> Box<dyn TransitionSystem> {
