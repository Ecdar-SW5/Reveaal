...
pub mod test {
    ...
    pub(crate) fn get_conjunction_transition_system(path: &Path, comp1: &str, comp2: &str) -> TransitionSystemPtr {
    ...
    pub(crate) fn create_clock_name_to_index(transition_system: &TransitionSystemPtr) -> HashMap<String, ClockIndex> {
