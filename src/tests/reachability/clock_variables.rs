...
mod reachability_parser_clock_variable_validation {
    ...
    #[test_case("reachability: Adm2 -> [L21](u>1); [L20]()";
    "The clock variable u in start state does not exist in the model")]
    #[test_case("reachability: Adm2 -> [L21](uwu>1); [L20]()";
    "The clock variable uwu in start state does not exist in the model")]
    ...
    fn query_parser_checks_invalid_clock_variables(parser_input: &str) {
        ...
        // This funciton runs the "get_state" function from extract_state, which we wish to test.
