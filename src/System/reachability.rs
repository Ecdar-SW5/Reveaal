...
pub fn is_reachable(begin_state: Option<State>, end_state: State, system: &dyn TransitionSystem) -> Option<Vec<SubPath>>
{
...
pub fn searchAlgorithm(start_state: State, end_state: State, system: &dyn TransitionSystem) -> Option<Vec<SubPath>>{
